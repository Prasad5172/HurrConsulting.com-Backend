...
const insertEvent = async (event) => {
    try {
      let response = await calendar.events.insert({
        ...
        conferenceDataVersion: 1, // This is required for creating conference data
        resource: event,
    ...
    conferenceData: {
      createRequest: {
        ...
        conferenceSolutionKey: {
          type: "hangoutsMeet" // Specify the conference solution type
        },
        status: {
          statusCode: "pending"
        }
...
let end = "2024-07-23T00:00:00.000Z";
...
// let eventId = "q0umcm60h4t1tmi1b601bkhkoc";
